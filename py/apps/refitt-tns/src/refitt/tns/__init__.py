...
# internal libs
from refitt.core import __version__
from refitt.core.logging import Logger
from refitt.tns.interface import TNSInterface, TNSError, TNSConfig, TNSNameSearchResult, TNSObjectSearchResult
from refitt.tns.manager import TNSQueryManager, TNSCatalogManager
from refitt.tns.service import TNSService
from refitt.tns.catalog import TNSCatalog
...
def main() -> int:
    """Entry-point for `refitt-tns` console application."""
    return TNSApp.main(sys.argv[1:])
